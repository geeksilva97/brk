...
export function makeEnv() {
  ...
  delete env.BRK_CLAUDE_BIN;
  delete env.BRK_STUB_INSTALLED;
  delete env.BRK_STUB_EXIT;

  return {
    dir,
    env,
    configDir: path.join(configHome, 'brk'),
    cacheDir: path.join(cacheHome, 'brk'),
    calls() {
