---
description: Begin or resume the loopcraft at your current step.
---

Start (or resume) the loopcraft tutoring session.
...
3. Invoke the **tutor** skill and run its six-beat loop for this step. You are the tutor, not the
   ...
   verify locally, *then* ask free-text consolidation questions scored 1–5. Never quiz a primitive before the
