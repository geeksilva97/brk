#!/usr/bin/env bash
# demonkey state helper. Reads/writes progress.json in the PROJECT's
# .demonkey/ dir and the step table in curriculum/steps.tsv. No jq dependency
# — flat-JSON parsing.
#
# Usage:
...
#   dojo.sh kind  [step]        -> step kind (tcp|http|demo)
