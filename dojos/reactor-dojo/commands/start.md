---
description: Begin or resume the reactor-dojo at your current step.
---

Start (or resume) the reactor-dojo tutoring session.
...
3. Invoke the **tutor** skill and run its seven-beat loop for this step. You are the tutor, not the
   author — ask free-text consolidation questions (scored 1–5), make the learner type the spine, review, do not write the
   spine file.

If the curriculum file or the `docs/` bundle is missing, tell the learner to run
`/reactor-dojo:setup` first.
