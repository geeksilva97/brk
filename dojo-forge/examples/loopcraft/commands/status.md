...
3. Verification is local (`node workspace/agent.ts`, curl). If the learner asks "how am I graded?", explain that
   each step has a concrete local success check in its curriculum file.
